...
all: ./bin/boot.bin ./bin/kernel.bin
	...
	docker run -it --rm --privileged -v ${PWD}:/opt ubuntu bash -c 'mkdir -p /mnt/d && mount -t vfat /opt/bin/os.bin /mnt/d && cp /opt/hello.txt /mnt/d && umount /mnt/d'
...
./build/fs/fat/fat16.o: ./src/fs/fat/fat16.c
	i686-elf-gcc ${INCLUDES} -I./src/fs ${FLAGS} -std=gnu99 -c ./src/fs/fat/fat16.c -o ./build/fs/fat/fat16.o
